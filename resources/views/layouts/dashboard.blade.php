            ...
            <div class="table-responsive mt-2 table" id="dataTable-1" role="grid" aria-describedby="dataTable_info">
                <table class="table my-0" id="dataTable">
                    ...
                    <tbody>
                        ...
                        @php
                            // logic menentukan warrna sesuai deadline
                            $deadline = Carbon::parse($spk->delivery_date);
                            $diffInDays = $deadline->diffInDays(Carbon::today(), false); // false untuk dapatkan angka negatif jika sudah lewat
                            $bgColor = 'bg-success'; // default hijau
                            if ($diffInDays <= 8 && $diffInDays > 2) {
                                $bgColor = 'bg-warning'; // kuning
                            } elseif ($diffInDays <= 2) {
                        ...
                        <tr>
                            <td>
                                <div class="{{ $bgColor }} text-white p-2 rounded">
                            ...
                            <td>
                                ...
                                <div><div class="progress mb-3 progress-sm"><div class="progress-bar bg-info" style="width: 50%;"></div></div></div>
                            </td>
